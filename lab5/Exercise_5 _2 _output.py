...
def calculate_future_value(monthly_investment, yearly_interest, years):
    ...
    monthly_interest_rate = yearly_interest / 12 /100 # fixed error
    months = years * 12
    #print("#months =",months,"- monthly_interest_rate =",monthly_interest_rate)

    # calculate future value
    future_value = 0.0
    for i in range(1, months+1): # fixed error
        future_value += monthly_investment
        monthly_interest = future_value * monthly_interest_rate
        future_value += monthly_interest
        #print("month =",i,"- future value =",future_value)
